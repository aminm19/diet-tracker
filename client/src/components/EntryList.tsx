...
export function EntryList({ status, entries, error, onRetry, onUpdated, onDeleted }: EntryListProps) {
  ...
  if (status === "error") {
    return (
      <div className="rounded-[2rem] bg-black/[0.03] p-2 ring-1 ring-black/5 shadow-[0_8px_40px_-12px_rgba(0,0,0,0.12)]">
        <div className="flex flex-col items-center gap-4 rounded-[calc(2rem-0.375rem)] bg-white p-10 text-center shadow-[inset_0_1px_1px_rgba(255,255,255,0.6)]">
  ...
  if (entries.length === 0) {
    return (
      <div className="rounded-[2rem] bg-black/[0.03] p-2 ring-1 ring-black/5 shadow-[0_8px_40px_-12px_rgba(0,0,0,0.12)]">
        <div className="flex flex-col items-center gap-3 rounded-[calc(2rem-0.375rem)] bg-white p-10 text-center shadow-[inset_0_1px_1px_rgba(255,255,255,0.6)]">
